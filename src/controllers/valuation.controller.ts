...
export class ValuationController {
    ...
    async calculateValuation(req: AuthenticatedRequest, res: Response, next: NextFunction): Promise<void> {
        try {
        ...
        if (!valuationReq.from_address || !valuationReq.to_address || !valuationReq.vehicle_type) {
            const missingFields = []
        ...
        const result = await this.valuationService.calculateValuation(valuationReq)
